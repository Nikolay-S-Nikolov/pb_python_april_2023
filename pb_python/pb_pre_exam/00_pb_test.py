...
if service_type == "express":
    if shipment_weight < 1:
        ...
        distance_km_price = 20
        overpriced = 0.01
    transport_price = distance_km * distance_km_price / 100
    overpriced_kg = distance_km_price/100 * overpriced
    overpriced_km = shipment_weight * overpriced_kg
    total_overpriced = distance_km * overpriced_km
    total = transport_price + total_overpriced
